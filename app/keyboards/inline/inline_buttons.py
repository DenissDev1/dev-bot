...
kb_more = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text='Скинути налаштування', callback_data='reset')
        ],
        [
            # InlineKeyboardButton(text='Стикер с расписанием звонков', callback_data='sticker')
        ],
        [
            InlineKeyboardButton(text='Рейтинг викладачів', switch_inline_query_current_chat='#p ')
        ],
        [
            InlineKeyboardButton(text='Розклад', switch_inline_query_current_chat='')
        ],
    ]
)
...
search_kb = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton('Знайти', switch_inline_query_current_chat='')
        ]
    ]
)
...
search_teacher = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton('Рейтинг викладачів', switch_inline_query_current_chat='#p ')
        ]
    ]
)
...
def get_group_buttons(week: ThisNextWeek, group: int, day: Week) -> InlineKeyboardMarkup:
    week_text = 'Наступнний' if week == week.this_week else 'Цей'
    buttons = []
...
def check_week(week: ThisNextWeek, day: Week) -> InlineKeyboardMarkup:
    week_text = 'Наступний' if week == week.this_week else 'Цей'
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
